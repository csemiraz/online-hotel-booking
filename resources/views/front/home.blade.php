    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="inner">
                    <div class="photo">
                        <img src="{{ asset('front/') }}/uploads/4.jpg" alt="">
                    </div>
                    <div class="text">
                        <h2><a href="">Standard Couple Bed</a></h2>
                        <div class="price">
            ...
            <div class="col-md-3">
                <div class="inner">
                    <div class="photo">
                        <img src="{{ asset('front/') }}/uploads/5.jpg" alt="">
                    </div>
                    <div class="text">
                        <h2><a href="">Standard Couple Bed</a></h2>
                        <div class="price">
            ...
            <div class="col-md-3">
                <div class="inner">
                    <div class="photo">
                        <img src="{{ asset('front/') }}/uploads/6.jpg" alt="">
                    </div>
                    <div class="text">
                        <h2><a href="">Standard Couple Bed</a></h2>
                        <div class="price">
            ...
            <div class="col-md-3">
                <div class="inner">
                    <div class="photo">
                        <img src="{{ asset('front/') }}/uploads/7.jpg" alt="">
                    </div>
                    <div class="text">
                        <h2><a href="">Standard Couple Bed</a></h2>
                        <div class="price">
        ...
        <div class="row">
            <div class="col-12">
                <div class="testimonial-carousel owl-carousel">
                    <div class="item">
                        <div class="photo">
                            <img src="{{ asset('front/') }}/uploads/t1.jpg" alt="">
                        </div>
                        <div class="text">
                            <h4>Robert Krol</h4>
                            <p>CEO, ABC Company</p>
                    ...
                    <div class="item">
                        <div class="photo">
                            <img src="{{ asset('front/') }}/uploads/t2.jpg" alt="">
                        </div>
                        <div class="text">
                            <h4>Sal Harvey</h4>
