...
@section('title', 'Edit | Photo Gallery Page')
                ...
                <div class="card-body">
                    <form action="{{ route('admin_page_photo_gallery_update') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            <label>Photo Gallery Heading *</label>
                            <input name="photo_gallery_heading" class="form-control" type="text" value="{{ $page_data->photo_gallery_heading }}">
                        </div>

                        <div class="form-group mb-3">
                            <label>Photo Gallery Status *</label>
