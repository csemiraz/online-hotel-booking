...
class BookingController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        if(!Auth::guard('customer')->check()) {
            return redirect()->back()->with('error', 'You have to login first to payment!');
        }
        if(!session()->has('cart_room_id')) {
            return redirect()->back()->with('error', 'Cart is emtpy!');
        }
    ...
    public function paypal($final_price)
    {
        ...
        $secret = 'EEDkbbwXONng8MOklL4E-1SRnsKX2FDUkEkLUityliwe2gVnslLXT7kaJilcJhxhj3f7UkN9Fxq6NTWd';
 ...
 */
            ...
            $subject = 'New Order';
            $message = 'You have made an order for online hotel booking. The booking information is given below: <br>';
    ...
    {
        $stripe_secret_key = 'sk_test_51O1AHbDt0n7FRPagWFsY9SS6VGdoyw3nlffjpRb04rYJc7CCI83VT6uR4YOWd1KlrnAl3SeIzqnHmkp4y8VCVs5P00xaTtoBUs';
